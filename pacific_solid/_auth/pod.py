...
from pacific_solid._http.headers import extract_metadata
from pacific_solid._rdf.namespaces import ACL, LDP, RDF
from pacific_solid._rdf.parse import parse_rdf
...
class Pod:
    ...
    async def grant(
        ...
        *,
        ...
        from pacific_solid._http.errors import NotFoundError
        try:
    ...
    async def discover_inbox(self, path: str) -> str | None:
        ...
        from pacific_solid._ldn.inbox import discover_inbox
    ...
    async def send_notification(self, inbox_path: str, notification: Graph) -> str:
        ...
        from pacific_solid._ldn.inbox import send_notification
    ...
    async def list_notifications(self, inbox_path: str) -> builtins.list[str]:
        ...
        from pacific_solid._ldn.inbox import list_notifications
