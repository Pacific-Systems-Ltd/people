...
from pacific_solid._graph.triple import URI, Literal, Triple, TripleObject
from pacific_solid._rdf.parse import parse_turtle
from pacific_solid._rdf.serialize import serialize_turtle
...
class Graph:
    ...
    def all(self, model_class: type) -> list[Any]:
        ...
        for t in type_triples:
            ...
            from_graph = getattr(model_class, "from_graph")  # injected by @ps.model
            results.append(from_graph(sub_graph))
        return results
