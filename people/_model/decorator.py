...
def model(cls: type[_T]) -> type[_T]:
    ...
    rdf_type_uri = str(cls.rdf_type)

    # Store fields on the class for introspection
    cls._ps_fields = fields
    cls._ps_rdf_type = rdf_type_uri

    # Build __init__
    def __init__(self: Any, **kwargs: Any) -> None:
        self._ps_subject: str | None = None
        self._ps_source_graph: Graph | None = None
    ...
    cls.graph = graph_property

    # Build .from_graph classmethod
    @classmethod  # type: ignore[misc]
    def from_graph(cls_inner: type, graph: Graph, *, strict: bool = True) -> Any:
